...
namespace EQGodot.resource_manager.wld_file.fragments
{
    ...
    {
        public List<Frag30MaterialDef> Materials
        {
            get; private set;
        }
        ...
        /// </summary>
        public Dictionary<string, Dictionary<int, Frag30MaterialDef>> Slots
        {
            get; private set;
        }
        ...
        public List<Frag30MaterialDef> AdditionalMaterials
        {
            get; set;
        }
        ...
        public override void Initialize(int index, int type, int size, byte[] data, WldFile wld)
        {
            ...
            {
                Frag30MaterialDef material = wld.GetFragment(Reader.ReadInt32()) as Frag30MaterialDef;
