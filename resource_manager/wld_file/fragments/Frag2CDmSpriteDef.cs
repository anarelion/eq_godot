...
public partial class Frag2CDmSpriteDef : WldFragment
{
    ...
    public override void Initialize(int index, int type, int size, byte[] data, WldFile wld)
    {
        ...
        MaterialList = wld.GetFragment(Reader.ReadInt32()) as Frag31MaterialPalette;
        //int meshAnimation = Reader.ReadInt32();

        //// Vertex animation only
        ////if (meshAnimation != 0) {
        ////    AnimatedVerticesReference = fragments[meshAnimation - 1] as WldMeshAnimatedVerticesReference;
        ////}
        ...
        //        TexCoords[texCoordCount + i] = new Vector2(0.0f, 0.0f);
        //    }
        //}
    }
}